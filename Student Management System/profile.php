...
<head>
    ...
    <link rel="icon" href="https://img.icons8.com/fluency/48/name--v1.png" type="image/x-icon">
...
<body style="font-family: 'Kanit',sans-serif;">
    ...
    <div class="container">
        <div>
            <h1 style="color:#f83600;">My Profile</h1>
            <hr>
            <p class="display-6 text-warning" >Name : <?php echo $_SESSION['name']; ?></p>
        </div>
    </div>
</body>
</html>